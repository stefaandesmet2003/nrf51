...
#define PIN_SPI_MISO         (28) // P0.22
#define PIN_SPI_MOSI         (29) // P0.23
#define PIN_SPI_SCK          (30) // P0.24
...
#define PIN_WIRE_SDA         (14u) // P0.20
#define PIN_WIRE_SCL         (16u) // P0.21
