...
#define CONFIG_ACCELEROMETER
// #define CONFIG_PEDALMAGNET
...
#ifdef CONFIG_PEDALMAGNET
  #define pinCrankRev   (17) // RX = P0.17
...
static void checkMagnetCrankRevs() {
